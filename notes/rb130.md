...
18. Some use case from Students
...
19. test methods mentioned in the course
...
21. The difference between `assert_equal` and `assert_same`
...
23. RVM
    ...
    4. `rvm use 2.3.1 --default`

    5. `rvm use default`

    6. create a `.ruby-version` file
    ...
    7. Set default version in home directory
